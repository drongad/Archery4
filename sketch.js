...
function handlePlayerArrowCollision() {
  ...
  for(var i = 0;i<playerArrows.length;i++ ){
    ...
    if(baseCollision.collided||computerCollision.collided||computerArcherCollision.collided){
      console.log("player arrow collision occured")
    }
  }
...
function handleComputerArrowCollision() {
  ...
  for(var j = 0;j<computerArrows.length;j++ ){
    ...
    var computerArcherCollision1 = Matter.SAT.collides(
      computerArrows[j].body,
      player.body
    );
    if(baseCollision1.collided||computerCollision1.collided||computerArcherCollision1.collided){
      console.log("computer arrow collision occured")
    }
  } 
}
